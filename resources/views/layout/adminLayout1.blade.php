...
<html lang="en">
    ...
    <head>
        ...
        <!-- Loader -->
        <link href="{{ asset('themes/assets/css/modules/materialadmin/css/theme-default/overlay.css') }}" rel='stylesheet' type='text/css'>
			...
			<div class="menubar-fixed-panel">
				...
				<div class="expanded">
					<a href="{{asset('admin/home')}}">
						<span class="text-lg text-bold text-primary ">{{env("PAGE_TITLE")}}</span>
					</a>
				</div>
			</div>
                            ...
                            <ul id="main-menu" class="gui-controls">
                                    ...
                                    <li>
                                     <a href="{{asset('admin/shelf/tagorders')}}"  @if($active == 'tagorders') class="active" @endif >
                                         ...
                                         <span class="title">Shelf TagOrders</span>
                                     </a>
                                     </li>
                                    @endif
...
<!--                                    <li>
                                            <a href="{{asset('admin/product')}}" @if($active == 'liquorsale') class="active" @endif>
                                   ...
                                   @if (Auth::user()->role=="Admin")
                                    ...
                                    <li>
                                     ...
                                     <li>
                                            <a href="{{asset('admin/tabusers')}}" @if($active == 'tabusers') class="active" @endif>
	...
	<!-- END BASE -->
        ...
        <div class="loading" id="loaderModal2">
                <div id='toster_status'><img src="{{asset('themes/assets/img/modules/materialadmin/loader.gif')}}" /><br/>Loading data... </div>
        </div>
        <!-- /.modal -->
