            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <!-- <div class="tools">
                                <a class="btn btn-flat hidden-xs ink-reaction" href="{{asset('admin/inventories/add')}}"><span class="glyphicon glyphicon-plus"></span> &nbsp;New Inventory</a>
                         </div> -->
                        </div>
                        ...
                        <div class="card-tiles">
                            <div class="hbox-md col-md-12">
                                <div class="hbox-column col-md-9">
                                    ...
                                    <form action="{{ URL::to('admin/importExcel') }}" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="start_toster();">
