...
<script>
    jQuery(document).ready(function () {
        $('#order_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{asset('admin/shelf/taginventory/result')}}",
            columns: [
                {data: 'id', name: 'products.id'},
                {data: 'store_id', name: 'products.store_id'},
                {data: 'location_id', name: 'products.location_id'},
...
//                {data: 'print', name: 'print'},
    ...
    function searchlist() {
        ...
        $('#order_table').DataTable({
            ...
            serverSide: true,
            destroy: true,
            ajax: "{{asset('admin/shelf/taginventory/result')}}/1/storeid=" + storeid + "/locationid=" + locationid + "/startdate=" + startdate + "/enddate=" + enddate,
            columns: [
                {data: 'id', name: 'products.id'},
                {data: 'store_id', name: 'products.store_id'},
                {data: 'location_id', name: 'products.location_id'},
