...
<script>
        jQuery(document).ready(function () { 
            $('#order_table').DataTable({
                ...
                {data: 'total_quantity', name: 'order.total_quantity'},
...
//                                $('#order_table').destroy();
                                ...
                                processing: true,
                                        serverSide: true,
                                        destroy: true,
                                        ajax: "{{asset('admin/orders/result')}}/1/storeid=" + storeid +"/locationid=" + locationid + "/startdate=" + startdate + "/enddate=" + enddate,
                                        columns: [
                                        {data: 'id', name: 'order.id'},
                                        {data: 'store_id', name: 'order.store_id'},
                                        {data: 'location_id', name: 'order.location_id'},
